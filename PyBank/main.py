...
with open(output_path, 'w') as text_file:
    ...
    print(f"Greatest Increase in Profits: {financialData[index_increase_change][0]} - ${greatest_increase_in_profits}", file = text_file)

    print(f"Greatest Decrease in Profits: {financialData[index_decrease_change][0]} - ${greatest_decrease_in_profits}", file = text_file)